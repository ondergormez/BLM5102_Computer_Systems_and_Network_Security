...
* Ek olarak bu ders [14-dos-more-ip.pdf](https://cs155.stanford.edu/lectures/14-dos-more-ip.pdf) dosyasındaki bilgilere benzer bilgiler işlendi. Buradan da bakılabilir.
...
## Örnek Paket
TODO: Sınavda derste gösterilen gibi örnek bir paket verilerek bunun parse edilmesi ve ne paketi olduğunun bulunması istenebilir.  
...
```
set-cookie içinde giden token nedeniyle, login (user, password) olduğum yerlere tekrar login olmadan gidebilirim.
...
* Zone transferi case i. DNS sunucuları arasındaki bağlantıda. Son kullanıcının bu komutlar ile işi olmaz.
