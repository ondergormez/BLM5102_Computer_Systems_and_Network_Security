...
Air Gap: Her servisi ayrı bir bilgsayarda (hardware) çalıştırıyoruz. Fiziksel olarak altyapılarıda (network katmanında) ayırmak gerekli.
* 10 servis varsa 10 unuda ayrı bir şekilde güncelleyeceğiz.
* Difficult to manage
