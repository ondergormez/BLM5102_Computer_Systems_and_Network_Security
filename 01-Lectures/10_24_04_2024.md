...
* Ek olarak bu ders [13-internet-protocols.pdf](https://cs155.stanford.edu/lectures/13-internet-protocols.pdf) dosyasındaki bilgilere benzer bilgiler işlendi. Buradan da bakılabilir.
...
* Layer 1 - Fiziksel Katman (Physical Layer): Elektrik sinyalleri, kablolar, fiber optik, vs.
* Layer 2 - Veri Bağlama Katmanı (Data Link Layer): Ethernet, MAC adresleri, switchler
* Layer 3 - Ağ Katmanı (Network Layer): Uçtan uca iletişim, sanal adresleme:  IP, yönlendirme, routerlar
* Layer 4 - Taşıma Katmanı (Transport Layer): TCP, UDP, portlar
* Layer 5 - Oturum Katmanı (Session Layer): Soket açma, SQL, RPC
* Layer 6 - Sunu Katmanı (Presentation Layer): Veri sıkıştırma, şifreleme
* Layer 7 - Uygulama Katmanı (Application Layer): HTTP, FTP, SMTP

# Fiziksel Katman
Manchester Encoding gibi kodlamalar olabilir.  
UART, RS-232, RS-485 gibi farklı fiziksel katman protokolleri vardır.
...
* RARP: Reverse ARP
* ICMP (Internet Control Message protocol) gibi protokoller çalışır.
...
* 2001:db8:85a3:: -> eşittir -> 2001:0db8:85a3:0000:0000:0000:0000:0000
