...
* Bu derste [01-intro.pdf](https://cs155.stanford.edu/lectures/04-principles_os_sec.pdf) dosyasındaki bilgiler işlendi.
...
Priviledge Elevation: Bir programın yetkisini yükseltme işlemi. Inpersonation: Bir başkasının kimliğine bürünme işlemidir.
* Bir süreliğine root yetkisi ile çalışmak isteyebiliriz. Bu durumda EUID root değerine yükseltilir.
* Sonrasında yapılan işler bittikten sonra saved user id ile eski yetkiye geri dönülür.
...
* CAP_NET_BIND_SERVICE: bind a socket Port < 1024
* CAP_SYS_PTRACE: Trace arbitrary processes using ptrace. Debug yapabilme yetkisi
